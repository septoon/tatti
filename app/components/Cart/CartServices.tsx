                  ...
                  <div>
                    ...
                    <div className="grid gap-6 md:grid-cols-2 mb-4">
                      {data.packages.map((pkg, index) => {
                        ...
                        return (
                          <div key={pkg.id} className={`${cartItem ? 'border-2 border-gray-400' : 'border-none'} bg-[#1e1e1e] p-4 rounded-lg cursor-pointer`}
                            onClick={() => {
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      {data.extras.map((extra, index) => {
                        ...
                        return (
                          <div key={extra.id} className={`${cartItem ? 'border-2 border-gray-400' : 'border-none'} bg-[#1e1e1e] p-4 rounded-lg cursor-pointer`} 
                          onClick={() => {
